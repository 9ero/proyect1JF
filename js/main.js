    ...
    data() {
        return {
            ...
            events: [
                ...
                { id: 5, title: 'Las bodas de Fígaro', 'description': 'De Wolfgang A. Mozart, se trata de una opera buffa -ópera de comedia- en cuatro actos con libreto en italiano de Lorenzo da Ponte, basado en Le mariage de Figaro de Pierre Augustin Caron de Beaumarchais. La pieza, considerada una de las más importantes de la historia de la música, estrenó en Viena, 1786, bajo la dirección de su compositor.', category: 'Teatro', image: './img/cards/event6.jpg', free: false, espacios: 75, atp: false, date: 'MON, May 31, 2021, 4:00 PM CST', location: 'San Carlos' },
                { id: 6, title: 'Conferencia Ministerial sobre la Sociedad de la Información de América Latina y el Caribe', 'description': 'En el año 2000 se inició un diálogo regional sobre la sociedad de la información y del conocimiento en América Latina y el Caribe, en el que los países afirmaron su voluntad de diseñar e implementar programas para el acceso y uso de las tecnologías de la información y las comunicaciones (TIC).', category: 'Conferencia', image: './img/cards/event7.jpg', free: true, espacios: 300, atp: true, date: 'MON, May 31, 2021, 4:00 PM CST', location: 'Online' },
                { id: 7, title: 'Reunión preparatoria de la Cuarta Conferencia Ministerial sobre Sociedad de la Información de América Latina y el Caribe', 'description': 'Un seminario, al que asistieron expertos y representantes de la sociedad civil y el sector privado, abordó temas como las estrategias digitales y la competitividad regional, las oportunidades de cooperación para el desarrollo digital en la región y la gestión de residuos tecnológicos.', category: 'Conferencia', image: './img/cards/event8.jpg', free: true, espacios: 300, atp: true, date: 'MON, May 31, 2021, 4:00 PM CST', location: 'Online' },
                { id: 8, title: 'Alimentación saludable durante la cuerantena, OMS', 'description': 'La vida se ha vuelto más sedentaria y los nuevos hábitos han eliminado el ejercicio que habitualmente hacíamos, sin embargo, comer menos, no es la solución en estos tiempos, ajustar nuestros hábitos de ejercicio y alimentación no es fácil, ¿cómo debe de ser nuestra dieta en estos tiempos?, ¿cómo podemos ajustar nuestros hábitos para tener una vida saludable en esta contingencia?', category: 'Conferencia', image: './img/cards/event9.jpg', free: true, espacios: 300, atp: true, date: 'THU, JUN 3, 2021, 8:00 PM CST', location: 'Online' },
            ]
        }
    },
    methods: {
